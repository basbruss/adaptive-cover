...
| Glare-Free Zone   | 0.5     | 0.1-2 | Distance from cover to area that is protected from direct sunlight. Measured horizontally from the bottom of the cover when fully extended |
...
| Glare-Free Zone            | 0.5     | 0.1-2 | Distance from cover to area that is protected from direct sunlight |
